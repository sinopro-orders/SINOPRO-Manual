...
<table><thead><tr><th width="247">특징</th><th>설명</th></tr></thead><tbody><tr><td>효율적인 열봉 성능</td><td>열봉헤드가 구리(Copper) 소재로 열전도율이 우수하며, 전력 소비 절감 및 작업 효율 향상. 동급 대비 에너지 절감 효과 우수</td></tr><tr><td>압력·가이드 제어</td><td>상하 열봉헤드 압력을 조절밸브로 실린더 구동 + 리니어 가이드 슬리브 구조로 부드러운 상하 작동</td></tr><tr><td>안정적인 밀봉·관찰 기능</td><td>실린더와 회전형 가이드 슬리브 방식의 커버 개폐, 투시창으로 챔버 내부 실시간 관찰</td></tr><tr><td>제품 대응력·조작 편의성</td><td>다양한 규격의 소형·중형 파우치 셀 대응, 치수 조정이 간단하고 조작이 직관적</td></tr><tr><td>설치 유연성</td><td>본체·제어박스 분리형 설계로 글러브박스 내 장착 또는 자동화 라인 설치 가능</td></tr><tr><td>사용자 친화적 설계</td><td>간편한 조작, 세련된 외관, 소형 경량 구조</td></tr><tr><td>오염 방지 설계</td><td>폐액 수집 트레이 내장으로 장비 내부 오염 방지</td></tr></tbody></table>
...
1. 오작동 방지를 위해 두명이상의 동시 작업은 권장하지 않으며 오작동 방지를 위해 시작버튼은 작업자가 두개를 동시에 눌러야지만 조작 가능합니다.
...
5. 위험상황 인지시 EMO 스위치를 눌러 제어를 진행 합니다.
...
<table><thead><tr><th width="301">스위치</th><th>기능</th></tr></thead><tbody><tr><td>Up-heat open/ close (상부가열) </td><td>상부 실링 헤드 가열 온/오프 전환</td></tr><tr><td>Down-heat open/ close (하부가열)</td><td>하부 실링 헤드 가열 온/오프 전환</td></tr><tr><td>Stop (비상 정지)</td><td>모든 동작 정지</td></tr><tr><td>Open lid (커버 캐폐)</td><td>챔버 커버 열림/닫힘 전환</td></tr><tr><td>Vacuum (진공)</td><td>진공 밸브 온/오프 전환 (실링 작업 시 열림 상태)</td></tr><tr><td>Inflator (가스 주입)</td><td>가스 주입 밸브 온/오프 전환 (실링 작업 시 닫힘 상태)</td></tr><tr><td>Sealing (실링)</td><td>실링 실린더 하강/상승 동작</td></tr><tr><td>Manual/ Auto (수동/자동)</td><td>수동 및 자동 모드 전환 (작업 시 자동 모드 사용)</td></tr></tbody></table>
