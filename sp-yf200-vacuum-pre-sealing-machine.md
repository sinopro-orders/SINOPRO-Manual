...
본 장비는 소형 및 중형 소프트 패키지 리튬이온 전지를 전해액 주입 후 정치 공정까지 완료한 다음, **진공 상태에서 열프레스로 예비 밀봉**하기 위한 장비입니다. 정밀하게 제어되는 진공 챔버와 공압식 열밀봉 유닛을 통해 셀의 알루미늄 라미네이트 필름을 자동으로 진공 열밀봉 처리합니다.

**핵심 특징**

<table><thead><tr><th width="247">특징</th><th>설명</th></tr></thead><tbody><tr><td>효율적인 열봉 성능</td><td>열봉헤드가 구리(Copper) 소재로 열전도율이 우수하며, 전력 소비 절감 및 작업 효율 향상. 동급 대비 에너지 절감 효과 우수</td></tr><tr><td>정밀한 압력·가이드 제어</td><td>상하 열봉헤드 압력을 조절밸브로 정밀 조정. 실린더 구동 + 리니어 가이드 슬리브 구조로 부드러운 상하 작동과 평행도 보장</td></tr><tr><td>안정적인 밀봉·관찰 기능</td><td>실린더와 회전형 가이드 슬리브 방식의 커버 개폐, 투시창으로 챔버 내부 실시간 관찰</td></tr><tr><td>제품 대응력·조작 편의성</td><td>다양한 규격의 소형·중형 파우치 셀 대응, 치수 조정이 간단하고 조작이 직관적</td></tr><tr><td>설치 유연성</td><td>본체·제어박스 분리형 설계로 글러브박스 내 장착 또는 자동화 라인 설치 가능</td></tr><tr><td>사용자 친화적 설계</td><td>간편한 조작, 세련된 외관, 소형 경량 구조</td></tr><tr><td>오염 방지 설계</td><td>폐액 수집 트레이 내장으로 장비 내부 오염 방지</td></tr></tbody></table>
...
<table><thead><tr><th width="301">항목</th><th>사양</th></tr></thead><tbody><tr><td>챔버 재질</td><td>알루미늄 합금 (내식성 우수, 견고한 구조)</td></tr><tr><td>진공도</td><td>-90kPa ~ 0 조절 가능 (진공 펌프는 구매자 별도 준비)</td></tr><tr><td>실링 헤드 온도</td><td>상온 ~ 250℃ 조절 가능 (제어 정밀도 ±2℃)</td></tr><tr><td>열실링 압력</td><td>0 ~ 7kg/cm² 조절 가능</td></tr><tr><td>열실링 시간</td><td>0 ~ 99초 조절 가능</td></tr><tr><td>실링 너비 / 최대 길이</td><td>5mm / 200mm</td></tr><tr><td>실링 헤드 평행도</td><td>무탄소 복사용지, 0.6MPa·200℃ 조건에서 밀봉 흔적 균일</td></tr><tr><td>공기 소비량</td><td>약 0.2L 압축 공기 / 1회 실링</td></tr><tr><td>작동 속도</td><td>분당 180회 이상</td></tr><tr><td>전원 / 소비 전력</td><td>220V·50Hz / 500W 히터, 가열 시 약 1kW</td></tr><tr><td>압축 공기 공급</td><td>0.5 ~ 0.7MPa</td></tr><tr><td>외형 치수</td><td>작업부 470×485×435mm · 제어박스 420×325×225mm</td></tr><tr><td>장비 무게</td><td>약 50kg</td></tr></tbody></table>
...
1. 오작동 방지를 위해 **두 명 이상의 동시 작업은 허용되지 않습니다.** (시작 버튼은 한 작업자가 양손으로 동시에 눌러 조작)
2. 전기 보호 장치와 안전 커버가 구비되어 있으며, 모든 동작 부품은 보호 커버 내부에 위치합니다. 보호 커버를 제거한 상태로 운전하지 마세요.
3. 외부 기술자나 지정되지 않은 인원은 장비를 임의로 분해하거나 조정할 수 없습니다.
4. 회로 구성 부품을 임의로 분해하거나 변경해서는 안 됩니다.

<table><thead><tr><th width="300">구분</th><th>주의 내용</th></tr></thead><tbody><tr><td>고온</td><td>실링 헤드는 최대 250℃까지 가열됩니다. 운전 중·정지 직후 실링 유닛 접촉 금지</td></tr><tr><td>전기</td><td>220V 전원 사용. 점검·정비 전 반드시 전원 차단</td></tr><tr><td>공압</td><td>0.5~0.7MPa 압축 공기 사용. 배관 분리 전 잔압 제거</td></tr></tbody></table>
...
| 진공    | Φ10 튜브        | 진공관으로 연결 (진공 펌프 별도 준비) |
